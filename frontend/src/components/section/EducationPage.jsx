      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onPrev}
            className="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-all flex items-center gap-2 text-gray-800"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onNext}
            className="px-8 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg hover:opacity-90 transition-all flex items-center gap-2 shadow-lg"
          >
            Next: Languages
