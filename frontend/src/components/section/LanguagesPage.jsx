      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onNext}
            className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:opacity-90 transition-all flex items-center gap-2 shadow-lg"
          >
            Next: Finish
